    ...
    <form onSubmit={handleSave} className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="border-b border-slate-200 pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          disabled={isSaving}
          className="inline-flex items-center justify-center gap-2 px-4 py-2 text-xs font-bold text-white bg-teal-600 hover:bg-teal-500 active:bg-emerald-700 disabled:opacity-50 rounded-xl transition-colors shadow-md shadow-emerald-600/30 cursor-pointer"
        >
          {isSaving ? (
