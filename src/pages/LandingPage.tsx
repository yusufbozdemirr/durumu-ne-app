      ...
      <header className="sticky top-0 z-40 backdrop-blur-md bg-[#0a1122]/90 border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-7 text-xs font-semibold text-slate-300">
            <a href="#urun-ozellikleri" className="hover:text-emerald-400 transition-colors">
              Ürün Özellikleri
            </a>
            <a href="#canli-simulasyon" className="hover:text-emerald-400 transition-colors">
              Canlı Önizleme
            </a>
            <a href="#nasil-calisir" className="hover:text-emerald-400 transition-colors">
              Nasıl Çalışır?
            </a>
            <Link to="/paketler" className="hover:text-emerald-400 transition-colors">
              Paketler & Fiyatlar
            </Link>
          </nav>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-400 mt-1">
              İletişim Hattı: <span className="text-white font-bold">{SUPPORT_PHONE_DISPLAY}</span>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 pb-8 border-b border-slate-800">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/hosgeldiniz" className="hover:text-emerald-400 transition-colors">
                    7 Gün Ücretsiz Dene
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/kvkk" className="hover:text-emerald-400 transition-colors">
                    KVKK Aydınlatma Metni
                  </Link>
                </li>
                <li>
                  <Link to="/gizlilik-politikasi" className="hover:text-emerald-400 transition-colors">
                    Gizlilik Politikası
                  </Link>
                </li>
                <li>
                  <Link to="/cerez-politikasi" className="hover:text-emerald-400 transition-colors">
                    Çerez Politikası
                  </Link>
                </li>
                <li>
                  <Link to="/kullanim-kosullari" className="hover:text-emerald-400 transition-colors">
                    Kullanım Şartları
                  </Link>
                </li>
              </ul>
