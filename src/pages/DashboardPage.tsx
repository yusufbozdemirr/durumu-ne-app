      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-xl">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold px-2.5 py-0.5 rounded-full bg-teal-50 text-teal-600 border border-teal-200">
              Canlı Servis Takibi
            </span>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-8 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-xl w-44 sm:w-56 text-slate-900 placeholder:text-slate-500 transition-colors focus:outline-hidden focus:border-teal-500"
              />
            </div>
            ...
            <button
              ...
              className="inline-flex items-center gap-1 text-xs font-semibold text-teal-600 hover:text-teal-600 hover:underline px-2 py-1 cursor-pointer"
            >
