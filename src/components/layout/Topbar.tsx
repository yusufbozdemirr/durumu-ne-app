...
export const Topbar: React.FC<TopbarProps> = ({
  ...
  return (
    <header className="h-16 bg-[#0a1122] border-b border-slate-800/90 px-4 sm:px-6 flex items-center justify-between gap-4 sticky top-0 z-30">
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        {!isAdmin && location.pathname !== '/vehicles/new' && (
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-white bg-emerald-600 hover:bg-emerald-500 active:bg-emerald-700 rounded-xl transition-colors shadow-md shadow-emerald-600/20"
          >
